    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative py-20 lg:py-32 overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8 leading-relaxed">
            Create a central hub for all your important links – publish, organize, and share them with your audience in one beautiful, easy-to-manage platform
          </p>
          ...
          <div className="mt-16 relative">
            ...
            <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-4">
              <div className="flex flex-wrap justify-center gap-2 opacity-50">
                <span className="px-3 py-1 text-xs bg-white rounded-full border border-purple-200 text-gray-600">Internal tools</span>
                <span className="px-3 py-1 text-xs bg-white rounded-full border border-purple-200 text-gray-600">Customer portals</span>
                <span className="px-3 py-1 text-xs bg-white rounded-full border border-purple-200 text-gray-600">SaaS apps</span>
                <span className="px-3 py-1 text-xs bg-white rounded-full border border-purple-200 text-gray-600">Content</span>
                <span className="px-3 py-1 text-xs bg-white rounded-full border border-purple-200 text-gray-600">Websites</span>
                <span className="px-3 py-1 text-xs bg-white rounded-full border border-purple-200 text-gray-600">Content management</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <p className="text-center text-gray-600 mb-8">Loved by teams around the world</p>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl text-gray-600 text-center max-w-3xl mx-auto mb-16">
            Share your entire digital presence with a single link — from social profiles to projects, all in one place.
          </p>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="bg-white rounded-3xl p-8 shadow-lg">
              ...
              <h3 className="text-3xl font-bold mb-4">
                Publish to <span className="bg-gradient-to-r from-blue-500 to-purple-600 bg-clip-text text-transparent">any data source</span>
              </h3>
              <p className="text-gray-600 mb-8 leading-relaxed">
                Tap into popular websites like Airtable,<br />
                Get the best content for your Links and Sites<br />
      ...
      <section className="py-20 bg-gradient-to-br from-orange-50 to-pink-50">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-16">
            Seamlessly integrate with your favorite platforms and share all your links through one smart, customizable page.
          </p>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="bg-white rounded-3xl p-8 shadow-lg">
              ...
              <p className="text-gray-600 leading-relaxed">
                Be the best publisher of your digital world share, organize, and showcase everything in one powerful link
              </p>
            </div>
            <div className="bg-gray-200 rounded-3xl h-96"></div>
          </div>
          ...
          <div className="mt-16">
            <div className="bg-white rounded-3xl p-8 shadow-lg max-w-2xl mx-auto">
              ...
              <p className="text-gray-600 leading-relaxed">
                Reach engaged audiences by placing your brand inside the link hubs they visit every day smart, seamless, and built for results.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl text-gray-600 text-center max-w-3xl mx-auto mb-16">
            NAME makes the publishing process more collaborative, so everyone can publish better experiences together.
          </p>
      ...
      <section className="py-20 bg-gray-900 text-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-5xl lg:text-6xl font-bold mb-6">Scale without limits</h2>
            ...
            {[
              {
                ...
                description: "Plasmic meets SOC 2 standards for secure handling of sensitive information."
              },
              {
                title: "SSO and Domain Capture",
                description: "Available for for both name collaborators and end users of your application."
              },
              {
                title: "Fine-Grained Permissions",
                description: "Assign and manage fine grained access controls both within name and your applications."
              },
              {
                title: "Branching & approvals",
                description: "Collaborate at scale by working on isolated copies, then review and merge when ready."
              },
              {
                title: "Shared Libraries",
                description: "Centrally manage assets across your organization. Import and reuse within various projects with ease."
              },
              {
                title: "On-Premise link Deployment",
                description: "Deploy your links on-premise or behind content for enhanced control and reach."
              }
            ].map((feature, index) => (
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              {
                quote: "It's already been a huge increase in efficiency for me, personally. I'm really looking forward to a huge drop in scope for our tests that require new components (most of them).",
                author: "James Armenta",
                company: "Intuit",
                role: "Software Engineer"
              },
              {
                quote: "Really excited about this UI to React components platform. Definitely see a bright future!",
                author: "Herminio Garcia",
                company: "Sidecar Health",
                role: "Software Engineer"
              },
              {
                quote: "By far one of the most empowering tools to come out in a while. If you're a designer/no coder/visual developer who wants to make world class applications, or a design or development studio looking for a way to serve your clients better and faster— check out Plasmic.",
      ...
      <section className="py-20 bg-gray-900 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-8">
            <span className="px-4 py-2 text-sm bg-white/10 rounded-full">no credit card needed</span>
            <span className="px-4 py-2 text-sm bg-white/10 rounded-full">Unlimited time on free plan</span>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-8">
            <div className="lg:col-span-1">
              ...
              <p className="text-gray-400 text-sm">Copyright © 2025 name, Inc. All rights reserved.</p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-gray-400">
                ...
                <li><a href="#" className="hover:text-white">Name Experts</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-gray-400">
                ...
                <li><a href="#" className="hover:text-white">Business apps</a></li>
                <li><a href="#" className="hover:text-white">Internal tools</a></li>
                <li><a href="#" className="hover:text-white">Admin panels</a></li>
                <li><a href="#" className="hover:text-white">React app builder</a></li>
                <li><a href="#" className="hover:text-white">All use cases</a></li>
              </ul>
            </div>
          </div>
